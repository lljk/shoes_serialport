module Make
  ...
  def common_build
    ...
    %w[req/serialport/ext/native req/binject/ext/binject_c req/ftsearch/ext/ftsearchrt req/bloopsaphone/ext/bloops req/chipmunk/ext/chipmunk].
      each { |xdir| copy_ext xdir, "dist/ruby/lib/#{SHOES_RUBY_ARCH}" }

    gdir = "dist/ruby/gems/#{RUBY_V}"
    {'serialport' => 'lib/serialport/ext', 'hpricot' => 'lib', 'json' => 'lib/json/ext', 'sqlite3' => 'lib'}.each do |gemn, xdir|
